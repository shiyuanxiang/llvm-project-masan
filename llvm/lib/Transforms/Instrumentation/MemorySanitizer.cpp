...
void MemorySanitizer::initializeModule(Module &M) {
  ...
  // [syx] check if the shadow memory base address and origin tracking base
  // address have been manually set
...
struct MemorySanitizerVisitor : public InstVisitor<MemorySanitizerVisitor> {
  ...
  // [syx] handle_xxx is dealing with the propogation of shadow value and origin
  ...
  //[syx] instrument alloca in stack
